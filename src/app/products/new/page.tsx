...
export default function NewProductPage() {
  ...
  const [formData, setFormData] = useState<ProductFormData>({
    name: '',
    sellingPrice: 0,
    initialStock: 1, // Khởi tạo với 1 thay vì 0
    formula: []
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Luôn luôn tạo production log vì initialStock > 0
      ...
      toast.success(`Đã tạo sản phẩm: ${formData.name} với ${formData.initialStock} sản phẩm có sẵn`);
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                    <Label htmlFor="initial-stock">Số lượng tạo ban đầu</Label>
                    <Input
                      id="initial-stock"
                      type="number"
                      min="1"
                      ...
                      placeholder="Số lượng sản phẩm tạo"
                      required
                    />
                  </div>
                </div>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    <strong>Tạo sản phẩm với số lượng ban đầu:</strong> Hệ thống sẽ tự động tạo sản phẩm với số lượng bạn chỉ định 
                    và ghi nhận chi phí sản xuất dựa trên công thức.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent>
                <Button
                  type="submit"
                  disabled={isSubmitting || !formData.name || formData.sellingPrice <= 0 || formData.formula.length === 0 || formData.initialStock <= 0}
                  className="w-full"
                  size="lg"
                >
                  {isSubmitting ? 'Đang tạo sản phẩm...' : `Tạo ${formData.initialStock} sản phẩm`}
                </Button>
              </CardContent>
            </Card>
          </form>
